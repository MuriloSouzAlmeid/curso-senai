...
namespace webapi.event_.Contexts
{
    ...
    public class Event_Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer("Server=tcp:eventmurilo-server.database.windows.net,1433;Initial Catalog=eventmurilo-database;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30; User Id=eventmurilo-server; Pwd=Senai@134");
