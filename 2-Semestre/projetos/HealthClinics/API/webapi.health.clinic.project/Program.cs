...
//adiciona serviços de autenticação Jwt Bearer
...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        //Título da API
        Title = "API Health Clinic - Projeto API, Sprint 2",

        //Descrição da API
        Description = "API do projeto Health Clinic para gerenciamento e listagem de consultas entre médicos e pacientes.",
